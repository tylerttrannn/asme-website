...
function EventCard({event, isReversed} : EventCardProps){
  return (
    <div className={`group flex flex-col md:flex-row ${isReversed ? 'md:flex-row-reverse' : ''} bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300`}>
      ...
      <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">        
        ...
        <button className="self-start text-gray-900 font-semibold hover:text-blue-600 transition-colors flex items-center gap-2">
          Learn More
